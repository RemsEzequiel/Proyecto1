...
namespace RemsServidor.Controllers
{
    public class CalificacionsController : Controller
    {
        ...
        {
            ViewBag.EstudianteId = new SelectList(db.Estudiantes, "Id", "Carnet");
        ...
        public ActionResult Create([Bind(Include = "Id,Notas,EstudianteId,AsignaturaId")] Calificacion calificacion)
        {
            ...
            ViewBag.EstudianteId = new SelectList(db.Estudiantes, "Id", "Carnet", calificacion.EstudianteId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Notas,EstudianteId,AsignaturaId")] Calificacion calificacion)
        {
            if (ModelState.IsValid)
            {
